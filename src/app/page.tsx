...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      buttons={[
        {
          text: "Call or Text Now: 562-588-8422",
      ...
      avatars={[
        ...
        },
        {
          ...
          alt: "Happy bearded man",
        },
        {
          src: "http://img.b2bpic.net/free-photo/smiley-woman-outdoors_23-2148613033.jpg",
          alt: "Smiley woman outdoors",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-person-football-game_23-2149015522.jpg",
          alt: "Person at a football game",
        },
        {
          src: "http://img.b2bpic.net/free-photo/medium-shot-man-with-headphones_23-2149009409.jpg",
  ...
  <div id="services" data-section="services">
      ...
      features={[
        ...
        {
          title: "Power Washing",
          description: "High-pressure washing for a deep, sanitized clean.",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=9e62g2",
          imageAlt: "Water icon",
        },
        {
          title: "Non-Harmful Chemicals",
          description: "Safe, eco-friendly products for your family and pets.",
          imageSrc: "http://img.b2bpic.net/free-photo/green-leaf-clay-craft-cute-nature-handmade-creative-art-graphic_53876-133037.jpg",
          imageAlt: "Leaf icon",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Sarah J.",
          date: "May 2024",
          title: "Bins never smelled this good!",
          quote: "Oscar's team did an amazing job! My bins have never smelled this fresh and clean. The service was fast and professional.",
          tag: "Smell Gone",
        ...
        },
        {
          ...
          name: "Michael T.",
          date: "April 2024",
          title: "Highly Recommend for Cleanliness",
          quote: "I was skeptical at first, but Oscar's Trash Bin Cleaning delivered! Our bins are spotless and I no longer worry about pests. Great job!",
          tag: "Pest-Free",
        ...
        },
        {
          ...
          quote: "Love that they use non-harmful chemicals. It's important to me, and the bins are still sparkling clean. Fantastic service!",
          tag: "Green Clean",
        ...
        },
        {
          ...
          quote: "Oscar's provides a super fast and reliable service. My bins are cleaned on schedule every time without any hassle. A true lifesaver!",
          tag: "Efficient",
        ...
        },
        {
          ...
          quote: "The pricing is very fair for the quality of service you receive. My bins feel brand new after every cleaning. Definitely worth it!",
          tag: "Affordable",
      ...
      features={[
        {
          ...
          description: "Select your preferred cleaning schedule that fits perfectly into your day.",
        ...
        },
        {
          ...
          description: "Modify or reschedule appointments with ease, directly from your phone.",
          imageSrc: "http://img.b2bpic.net/free-vector/colorful-project-schedule-template-with-flat-design_23-2147946499.jpg",
          imageAlt: "Clock icon",
        },
        {
          title: "Recurring Cleanings",
          description: "Set up weekly, bi-weekly, or monthly cleanings for continuous freshness.",
          imageSrc: "http://img.b2bpic.net/free-vector/illustration-reverse-clock-icon_53876-5629.jpg",
          imageAlt: "Repeat icon",
        },
        {
          title: "Text Reminders",
          description: "Get convenient text reminders before your appointment, so you never miss a clean!",
          imageSrc: "http://img.b2bpic.net/free-photo/yellow-note-with-word-work-marker-blue-background-flat-lay_169016-33584.jpg",
